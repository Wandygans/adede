...
async function startHisoka() {
    const hisoka = hisokaConnect({
        ...
        browser: ['Wangsaf Multi Device','Safari','1.0.0'],
        auth: state
    })
    ...
    hisoka.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                    hisoka.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `Welcome To ${metadata.subject} \n Hai @${num.split("@")[0]} 👋\nJangan Lupa Nimbrung Dan Semoga Betah` })
